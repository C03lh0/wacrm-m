...
export function Step1ChooseTemplate({ selectedTemplate, onSelect, onNext, onBack }: Step1Props) {
  ...
  // Evolution-connected accounts never reach this component — the
  // wizard renders Step1PlainTextBody for them instead, since
  // Evolution has no template-approval workflow (see new/page.tsx).
  return (
